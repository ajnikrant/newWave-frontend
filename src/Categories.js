...
function Categories({ filteredByCat, selectedCat, setSelectedCat, catClicked, setCatClicked, filterByPrice, setFilterChange, setSaleChange, saleTypeSelection, removeDeleted }){
    ...
    return (
        ...
        <br></br><br></br>
            ...
            {catClicked ? <ItemList filteredByCat={filteredByCat} removeDeleted={removeDeleted}/> : null}
            {catsArr}
        </>
    )
}
